...
namespace Taschenrechner.View
{
    public partial class FormParametereingabe : Form
    {
        ...
        {
            this.tbox_result.Text += "1";
        }

        private void btn_2_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "2";
        }

        private void btn_3_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "3";
        }

        private void btn_4_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "4";
        }

        private void btn_5_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "5";
        }

        private void btn_6_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "6";
        }

        private void btn_7_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "7";
        }

        private void btn_8_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "8";
        }

        private void btn_9_Click(object sender, EventArgs e)
        {
            this.tbox_result.Text += "9";
        }
